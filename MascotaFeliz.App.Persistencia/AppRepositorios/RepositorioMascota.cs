...
namespace MascotaFeliz.App.Persistencia
{
    public class RepositorioMascota : IRepositorioMascota
    {
        ...
        {//metodo constructor de RepositorioMascota
       ...
       public IEnumerable<Mascota> GetAllMascotas()
        {
            //Permite cargar todos los dueños que estan en la base de datos, y la añade a GetAllMascotas
            //de tipo IEnumerable<Mascota>
